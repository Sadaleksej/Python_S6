...
if __name__ == '__main__':
    ...
    for count in range(length_of_board):
        row, col = (int(i) - 1 for i in input(f"Введите пару координат № {count + 1} через пробел: (от 0 до 7) ").split(" "))
